...
export default function ChatsOpen({ isOpen, onClose }: MessageProps) {
    const [message, setMessage] = useState("");
    const [messages, setMessages] = useState([
        { sender: "You", message: "No worries. It will be completed ASAP. I’ve asked him yesterday.", time: "19:32", date: "June 08, 2021", type: "sent" },
        { sender: "Mary Hilda", message: "Hello Obaidullah, I will be your case advisor for case #029290. I have assigned some homework for you to fill.", time: "19:32", date: "June 09, 2021", type: "received" },
        { sender: "You", message: "Please contact Mary for questions regarding the case bcs she will be managing your forms from now on! Thanks Mary.", time: "19:32", date: "June 09, 2021", type: "sent" },
        { sender: "Mary Hilda", message: "Sure thing, Claren", time: "19:32", date: "June 09, 2021", type: "received" },
        { sender: "Obaidullah Amarkhil", message: "Morning. I’ll try to do them. Thanks", time: "19:32", date: "June 09, 2021", type: "received" },
    ]);
    ...
    const senderColors: { [key: string]: { textColor: string, bgColor: string } } = {
        "Mary Hilda": { textColor: "#E5A443", bgColor: "#FFF4E1" },
        "You": { textColor: "#9B51E0", bgColor: "#EEDCFF" },
        "Obaidullah Amarkhil": { textColor: "#43B78D", bgColor: "#D2F2EA" },
    };
    ...
    return (
        <>
            ...
            <div className="flex flex-row items-center border-b">
                ...
                <div className="ml-4 mr-20 mb-4">
                    <h2 className="text-[#2F80ED] text-lg font-lato-bold">I-589 - AMARKHIL, Obaidullah [Affirmative Filing with ZHN]</h2>
                    <p className="text-[14px] font-lato text-gray-600">3 Participants</p>
                </div>
